            ...
            <div className="space-y-3">
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                        <div className={`font-medium text-sm ${currentStep >= 1 ? "text-foreground" : "text-muted-foreground"}`} >
                            Company Details
                        </div>
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                        <div className={`font-medium text-sm ${currentStep >= 2 ? "text-foreground" : "text-muted-foreground"}`}  >
                            Lead Details
                        </div>
