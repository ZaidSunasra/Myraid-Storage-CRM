...
const LeadScheduling = () => {
	...
	const form = useForm({ resolver: zodResolver(addReminderSchema), defaultValues: { title: "", send_at: undefined, message: "", lead_id: parseInt(id || ""), reminder_type: "client_meeting" } });
