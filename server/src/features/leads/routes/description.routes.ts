...
import { getDescriptionsController, getDescriptionByIdController, addDescriptionController, editDescriptionController, deleteDescriptionController} from "../controllers/description.controller";

const descriptionRouter = express.Router();

descriptionRouter.get("/get/:lead_id", authMiddleware, checkDepartment(["admin", "sales"]), getDescriptionsController);
